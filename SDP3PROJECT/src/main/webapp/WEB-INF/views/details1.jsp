      ...
      <nav id="navbar" class="navbar">
        <ul>
         <li><a class="nav-link scrollto " href="index">Home</a></li>
          <li><a class="nav-link scrollto" href="index">About Us</a></li>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong>: E-Waste</li>
                
                <li><strong>Video URL</strong>: <a href="https://www.youtube.com/watch?v=NwE2jgaxX64">https://www.youtube.com/watch?v=NwE2jgaxX64</a></li>
              </ul>
            </div>
...
E-waste recycling then refers to the reprocessing and re-use of these electronic wastes. 
It is simple.  It is a process that seeks to recover material from electronic waste. This way,
you can use them in new electronic products.
...
They may also be in the form of information tech equipment like your computers, laptops, 
mobile phones, batteries, hard disks, circuit boards, monitors.
You should know that e-waste is quite crucial because electronics have a short useful life. 
As such, they become electronic waste at a swift pace
              </p>
            </div>
          </div>
